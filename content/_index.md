...
sections:
  ...
  - block: markdown
    ...
    content:
      ...
      subtitle: ''
      text: |-
        <span style="color:red"> I am looking for highly motivated students with solid background in probability, linear algebra and/or optimization, and good programming skills. If you are interested in joining my group, welcome to contact me via <a href="shiboli.cs@gmail.com" style="color: blue; text-decoration: underline;text-decoration-style: dotted;">shiboli.cs@gmail.com</a>. In particular, if you have a strong math and/or physics background (e.g., with a BS degree in math or physics) and also have coding experiences, e.g., matlab and python), feel free to schedule a meeting with me.</span>
